  ...
  IIncludable<DonationResource, DonationIncludable>
{
  ...
  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Donation>> PostAsync(Donation resource)
    => base.PostAsync(resource);

  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Donation>> PatchAsync(Donation resource)
  ...
  IQueryable<DonationResourceCollection, DonationQueryable>
{
  ...
  /// <inheritdoc />
  public DonationResourceCollection Query(params (DonationQueryable, string)[] queries)
    => base.Query(queries);
}
