  ...
  IIncludable<BatchGroupResource, BatchGroupIncludable>
{
  ...
  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<BatchGroup>> PostAsync(BatchGroup resource)
    => base.PostAsync(resource);

  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<BatchGroup>> PatchAsync(BatchGroup resource)
  ...
  IQueryable<BatchGroupResourceCollection, BatchGroupQueryable>
{
  ...
  /// <inheritdoc />
  public BatchGroupResourceCollection Query(params (BatchGroupQueryable, string)[] queries)
    => base.Query(queries);
}
