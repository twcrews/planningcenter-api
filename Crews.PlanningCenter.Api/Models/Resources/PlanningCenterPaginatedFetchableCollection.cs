...
/// <inheritdoc />
public abstract class PlanningCenterPaginatedFetchableCollection<TResource, TSelf, TSingleton, TContext>(
	Uri uri, HttpClient client)
	: PlanningCenterFetchableResource<TSelf>(uri, client), IPaginatedFetchableCollection<TResource>
	where TSelf : PlanningCenterPaginatedFetchableCollection<TResource, TSelf, TSingleton, TContext>
