...
public class PeopleDocumentContext : PlanningCenterDocumentContext
{
  ...
  protected override void OnServiceModelCreating(IServiceModelBuilder builder)
  {
    ...
    builder.Configurations.Add(new BackgroundCheckConfiguration());
  ...
  internal class BackgroundCheckConfiguration : ResourceTypeBuilder<BackgroundCheck> { public BackgroundCheckConfiguration() { } }
