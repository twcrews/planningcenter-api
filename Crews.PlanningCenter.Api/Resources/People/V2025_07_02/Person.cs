  ...
  IIncludable<PersonResource, PersonIncludable>
{
  ...
  /// <summary>
  /// The related <see cref="BackgroundCheckResourceCollection" />.
  /// </summary>
  public BackgroundCheckResourceCollection BackgroundChecks => GetRelated<BackgroundCheckResourceCollection>("background_checks");
  ...
  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Person>> PostAsync(Person resource)
