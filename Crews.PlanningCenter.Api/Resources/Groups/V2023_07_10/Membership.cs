  ...
  IIncludable<MembershipResource, MembershipIncludable>
{
  ...
  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Membership>> PostAsync(Membership resource)
    => base.PostAsync(resource);

  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Membership>> PatchAsync(Membership resource)
  ...
  IQueryable<MembershipResourceCollection, MembershipQueryable>
{
  ...
  /// <inheritdoc />
  public MembershipResourceCollection Query(params (MembershipQueryable, string)[] queries)
    => base.Query(queries);
}
