  ...
  IIncludable<BatchResource, BatchIncludable>
{
  ...
  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Batch>> PostAsync(Batch resource)
    => base.PostAsync(resource);

  /// <inheritdoc />
  public new Task<JsonApiSingletonResponse<Batch>> PatchAsync(Batch resource)
  ...
  IQueryable<BatchResourceCollection, BatchQueryable>
{
  ...
  /// <inheritdoc />
  public BatchResourceCollection Query(params (BatchQueryable, string)[] queries)
    => base.Query(queries);
}
